...
export function LanguageSwitch({ locale, messages }: LanguageSwitchProps) {
  ...
  return (
    <Link
      ...
      className="fixed left-5 top-5 z-40 border border-white/55 bg-black/28 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-white outline-none backdrop-blur-sm transition duration-300 hover:border-white hover:bg-white hover:text-[#071A33] focus-visible:ring-2 focus-visible:ring-white sm:left-7 sm:top-7"
      dir="ltr"
