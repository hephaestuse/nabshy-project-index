...
export function LanguageSwitch({ locale, messages }: LanguageSwitchProps) {
  ...
  return (
    <Link
      ...
      className="fixed left-5 top-5 z-40 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white outline-none backdrop-blur-xl transition duration-300 hover:bg-white/80 hover:text-[#071A33] focus-visible:ring-2 focus-visible:ring-white sm:left-7 sm:top-7"
      dir="ltr"
