...
export function HeroSection({
  ...
  const buttonClassName =
    messages.locale === "fa"
      ? "min-h-12 w-full max-w-xs border border-white/80 bg-white px-5 py-3 text-sm font-normal text-black outline-none transition duration-300 hover:bg-black hover:text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-4 focus-visible:ring-offset-transparent sm:w-auto sm:max-w-none sm:px-10 sm:py-4"
